...
class Posenet(
  ...
  fun estimateSinglePose(bitmap: Bitmap): Person {
    ...
    enumValues<BodyPart>().forEachIndexed { idx, it ->
      ...
      keypointList[ix].bodyPart = it
      keypointList[ix].position.x = xCoords[ix]
      keypointList[ix].position.y = yCoords[ix]
      keypointList[ix].score = confidenceScores[ix]
      totalScore += confidenceScores[ix]
    }
    keypointList[1].score = 0f;
    keypointList[2].score = 0f;
    keypointList[3].score = 0f;
    keypointList[4].score = 0f;
